        ...
        <div class="main-body-wrapper">
            ...
            <main>
                <div class="container" style="padding: 80px;">
                    ...
                    <p>BẠN CÓ CHẮC CHẮN MUỐN XÓA ĐƠN HÀNG: <strong><?= htmlspecialchars($order['order_id']) ?></strong> ? </p>
                    <form action="<?= $PUBLIC_URL ?>index.php?page=delete_order&id=<?= $order['order_id'] ?>" method="POST">
                        
                        <button type ="submit" name="delete_order" class="btn btn-danger">Xóa</button>
                        <a href="<?= $PUBLIC_URL ?>index.php?page=orders" class="btn btn-secondary">Hủy</a>
